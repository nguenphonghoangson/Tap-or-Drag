...
namespace TapOrDrag
{
    ...
    public sealed class SkinDef
    {
        ...
        public string Body, BodyLight, BodyShade, Beak, BeakShade, Cheek, Wing, WingShade; // dog: Beak = tongue, BeakShade = nose, Wing = ear
        ...
        public static readonly SkinDef[] All =
        {
            new SkinDef
            {
                ...
                Cheek = "ff9eb5", Wing = "c77a32", WingShade = "8f5520",
            ...
            new SkinDef
            {
                ...
                Cheek = "ff9ac0", Wing = "5a6784", WingShade = "3f4a63",
            ...
            new SkinDef
            {
                ...
                Cheek = "ff5f8f", Wing = "ffc4e1", WingShade = "e88ab8",
            ...
            new SkinDef
            {
                ...
                Cheek = "7a5a9a", Wing = "3a3552", WingShade = "2a2540",
                Scarf = null,
            ...
            new SkinDef
            {
                ...
                Cheek = "3ff0ff", Wing = "9aa8c0", WingShade = "6c7a96",
            ...
            new SkinDef
            {
                ...
                Cheek = "ff8fb0", Wing = "e8a820", WingShade = "b87a10",
